...
3. [`PLAN.md`](./PLAN.md) — progress tracker, update as you complete each project's Build/Done-when/Measure steps
4. [`projects/`](./projects/) — one folder per rung of the ladder, each with a `README.md` (actionable checklist) and stub code to fill in
5. [`common/`](./common/) — shared Ollama client used by every project
